...
class TopoVisitor(IEGenObject):
	...
	def visitIDGDataDep(self,node): self.atIDGDataDep(node)
	...
	def visitIDGGenDataDep(self,node): self.atIDGGenDataDep(node)
