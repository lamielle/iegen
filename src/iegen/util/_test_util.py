...
test_sets=(
	...
	("{[a]}","PresSet(VarTuple(['a']),Conjunction([]))"),
	("{[a,b]}","PresSet(VarTuple(['a', 'b']),Conjunction([]))"),
	("{[a,b,c]}","PresSet(VarTuple(['a', 'b', 'c']),Conjunction([]))"),
	("{[]:6=7}","PresSet(VarTuple([]),Conjunction([Equality(NormExp([],-1))]))"),
	("{[a]:6=7}","PresSet(VarTuple(['a']),Conjunction([Equality(NormExp([],-1))]))"),
	("{[a,b]:6=7}","PresSet(VarTuple(['a', 'b']),Conjunction([Equality(NormExp([],-1))]))"),
	("{[a,b,c]:6=7}","PresSet(VarTuple(['a', 'b', 'c']),Conjunction([Equality(NormExp([],-1))]))"),
	("{[]:6=7}","PresSet(VarTuple([]),Conjunction([Equality(NormExp([],-1))]))"),
	("{[]:6=7}","PresSet(VarTuple([]),Conjunction([Equality(NormExp([],-1))]))"),
	("{[]:6=7}","PresSet(VarTuple([]),Conjunction([Equality(NormExp([],-1))]))"),
	("{[a]:6=7}","PresSet(VarTuple(['a']),Conjunction([Equality(NormExp([],-1))]))"),
	...
	("{[a,b]: a=1}","PresSet(VarTuple(['a', 'b']),Conjunction([Equality(NormExp([VarExp(1,'a')],-1))]))"),
	("{[a,b]: b=1}","PresSet(VarTuple(['a', 'b']),Conjunction([Equality(NormExp([VarExp(1,'b')],-1))]))"),
	("{[a,b]: a'=1}","PresSet(VarTuple(['a', 'b']),Conjunction([Equality(NormExp([VarExp(1,\"a'\")],-1))]))"),
	("{[a,b]: b'=1}","PresSet(VarTuple(['a', 'b']),Conjunction([Equality(NormExp([VarExp(1,\"b'\")],-1))]))"),
	("{[a,b]: a=b}","PresSet(VarTuple(['a', 'b']),Conjunction([Equality(NormExp([VarExp(-1,'b'), VarExp(1,'a')],0))]))"),
	("{[a,b]: a'=b'}","PresSet(VarTuple(['a', 'b']),Conjunction([Equality(NormExp([VarExp(-1,\"b'\"), VarExp(1,\"a'\")],0))]))"),
	("{[a,b]: a=a' && b=b'}","PresSet(VarTuple(['a', 'b']),Conjunction([Equality(NormExp([VarExp(-1,\"a'\"), VarExp(1,'a')],0)), Equality(NormExp([VarExp(-1,\"b'\"), VarExp(1,'b')],0))]))"),
...
test_relations=(
	...
	("{[a]->[]}","PresRelation(VarTuple(['a']),VarTuple([]),Conjunction([]))"),
	...
	("{[a,b,c]->[a',b',c']}","PresRelation(VarTuple(['a', 'b', 'c']),VarTuple([\"a'\", \"b'\", \"c'\"]),Conjunction([]))"),
	("{[]->[]:6=7}","PresRelation(VarTuple([]),VarTuple([]),Conjunction([Equality(NormExp([],-1))]))"),
	("{[a]->[]:6=7}","PresRelation(VarTuple(['a']),VarTuple([]),Conjunction([Equality(NormExp([],-1))]))"),
	("{[a,b]->[]:6=7}","PresRelation(VarTuple(['a', 'b']),VarTuple([]),Conjunction([Equality(NormExp([],-1))]))"),
	("{[a,b,c]->[]:6=7}","PresRelation(VarTuple(['a', 'b', 'c']),VarTuple([]),Conjunction([Equality(NormExp([],-1))]))"),
	("{[]->[a']:6=7}","PresRelation(VarTuple([]),VarTuple([\"a'\"]),Conjunction([Equality(NormExp([],-1))]))"),
	("{[]->[a',b']:6=7}","PresRelation(VarTuple([]),VarTuple([\"a'\", \"b'\"]),Conjunction([Equality(NormExp([],-1))]))"),
	("{[]->[a',b',c']:6=7}","PresRelation(VarTuple([]),VarTuple([\"a'\", \"b'\", \"c'\"]),Conjunction([Equality(NormExp([],-1))]))"),
	("{[a]->[a']:6=7}","PresRelation(VarTuple(['a']),VarTuple([\"a'\"]),Conjunction([Equality(NormExp([],-1))]))"),
	("{[a,b]->[a',b']:6=7}","PresRelation(VarTuple(['a', 'b']),VarTuple([\"a'\", \"b'\"]),Conjunction([Equality(NormExp([],-1))]))"),
	("{[a,b,c]->[a',b',c']:6=7}","PresRelation(VarTuple(['a', 'b', 'c']),VarTuple([\"a'\", \"b'\", \"c'\"]),Conjunction([Equality(NormExp([],-1))]))"),

	("{[a,b]->[a',b']: a=1}","PresRelation(VarTuple(['a', 'b']),VarTuple([\"a'\", \"b'\"]),Conjunction([Equality(NormExp([VarExp(1,'a')],-1))]))"),
	("{[a,b]->[a',b']: b=1}","PresRelation(VarTuple(['a', 'b']),VarTuple([\"a'\", \"b'\"]),Conjunction([Equality(NormExp([VarExp(1,'b')],-1))]))"),
	("{[a,b]->[a',b']: a'=1}","PresRelation(VarTuple(['a', 'b']),VarTuple([\"a'\", \"b'\"]),Conjunction([Equality(NormExp([VarExp(1,\"a'\")],-1))]))"),
	("{[a,b]->[a',b']: b'=1}","PresRelation(VarTuple(['a', 'b']),VarTuple([\"a'\", \"b'\"]),Conjunction([Equality(NormExp([VarExp(1,\"b'\")],-1))]))"),
	("{[a,b]->[a',b']: a=b}","PresRelation(VarTuple(['a', 'b']),VarTuple([\"a'\", \"b'\"]),Conjunction([Equality(NormExp([VarExp(-1,'b'), VarExp(1,'a')],0))]))"),
	("{[a,b]->[a',b']: a'=b'}","PresRelation(VarTuple(['a', 'b']),VarTuple([\"a'\", \"b'\"]),Conjunction([Equality(NormExp([VarExp(-1,\"b'\"), VarExp(1,\"a'\")],0))]))"),
	("{[a,b]->[a',b']: a=a' && b=b'}","PresRelation(VarTuple(['a', 'b']),VarTuple([\"a'\", \"b'\"]),Conjunction([Equality(NormExp([VarExp(-1,\"a'\"), VarExp(1,'a')],0)), Equality(NormExp([VarExp(-1,\"b'\"), VarExp(1,'b')],0))]))"),
