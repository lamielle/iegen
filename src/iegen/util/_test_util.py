...
test_sets=(
	...
	("{[a,b]: a=b' && b=a'}","PresSet(VarTuple([VarExp(1,'a'), VarExp(1,'b')]),Conjunction([Equality(NormExp([VarExp(-1,\"a'\"), VarExp(1,'b')],0)), Equality(NormExp([VarExp(-1,\"b'\"), VarExp(1,'a')],0))]))"),
	...
	("{[a,b]: a=b && a=a' and a'=b' && a=1}","PresSet(VarTuple([VarExp(1,'a'), VarExp(1,'b')]),Conjunction([Equality(NormExp([VarExp(1,'a')],-1)), Equality(NormExp([VarExp(-1,\"a'\"), VarExp(1,'a')],0)), Equality(NormExp([VarExp(-1,'b'), VarExp(1,'a')],0)), Equality(NormExp([VarExp(-1,\"b'\"), VarExp(1,\"a'\")],0))]))"),
...
test_relations=(
	...
	("{[a,b]->[a',b']: a=b' && b=a'}","PresRelation(VarTuple([VarExp(1,'a'), VarExp(1,'b')]),VarTuple([VarExp(1,\"a'\"), VarExp(1,\"b'\")]),Conjunction([Equality(NormExp([VarExp(-1,\"a'\"), VarExp(1,'b')],0)), Equality(NormExp([VarExp(-1,\"b'\"), VarExp(1,'a')],0))]))"),
	...
	("{[a,b]->[a',b']: a=b && a=a' and a'=b' && a=1}","PresRelation(VarTuple([VarExp(1,'a'), VarExp(1,'b')]),VarTuple([VarExp(1,\"a'\"), VarExp(1,\"b'\")]),Conjunction([Equality(NormExp([VarExp(1,'a')],-1)), Equality(NormExp([VarExp(-1,\"a'\"), VarExp(1,'a')],0)), Equality(NormExp([VarExp(-1,'b'), VarExp(1,'a')],0)), Equality(NormExp([VarExp(-1,\"b'\"), VarExp(1,\"a'\")],0))]))"),
