...
class ImportTestCase(TestCase):
	...
	def testNameImport(self):
		try:
			from iegen.util import run_tests,full_iter_space,invert_dict,define_properties,like_type,raise_objs_not_like_types,DimensionalityError,sort_self,sort_result,check
