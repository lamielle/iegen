...
class ImportTestCase(TestCase):
	...
	def testNameImport(self):
		try:
			from iegen.util import run_tests,full_iter_space,invert_dict,define_properties,DimensionalityError,tuple_gen,lower_gen,upper_gen,parse_test,ast_equality_test,test_sets,test_relations
		except Exception,e:
