...
/* For no transformations: iegen/bin/iegen examples/moldyn_simple_notrans.spec -o examples/moldyn_simple_notrans.c --inspector-name=inspector_notrans --executor-name=executor_notrans*/
...
/* g++ ./examples/moldyn_simple_driver.c -g -I./src/dev src/dev/ExplicitRelation.c src/dev/RectDomain.c src/dev/util.c src/dev/ERG_cpack.c -o ./examples/moldyn_simple_driver && ./examples/moldyn_simple_driver */
