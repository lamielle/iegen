...
/* For no transformations: iegen/bin/iegen examples/moldyn_fst_notrans.spec -o examples/moldyn_fst_notrans.c --inspector-name=inspector_notrans --executor-name=executor_notrans*/
/* For transformations: iegen/bin/iegen examples/moldyn_fst.spec -o examples/moldyn_fst_trans.c --inspector-name=inspector_trans --executor-name=executor_trans*/
/* To compile and run: g++ ./examples/moldyn_fst_driver.c -g -I./src/dev src/dev/ExplicitRelation.c src/dev/RectDomain.c src/dev/util.c src/dev/ERG_cpack.c -o ./examples/moldyn_fst_driver && ./examples/moldyn_fst_driver */
...
int main()
{
	...
	inspector_trans(N,fx_notrans,inter1_notrans,inter2_notrans,T,x_notrans,n_inter,sigma);
	printf("done\n");
	printf("Performing transformed computation... ");
	executor_trans(N,fx_notrans,inter1_notrans,inter2_notrans,T,x_notrans,n_inter,sigma);
	printf("done\n");
