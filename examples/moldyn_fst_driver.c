...
/* To compile and run: g++ ./examples/moldyn_fst_driver.c -g -I./src/dev src/dev/ExplicitRelation.c src/dev/RectDomain.c src/dev/util.c src/dev/ERG_cpack.c -o ./examples/moldyn_fst
