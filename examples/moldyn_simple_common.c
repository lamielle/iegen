...
#define MOLDYN_SIMPLE_COMMON_DECL /* Symbolic constants */\
	int N=10,n_inter=5;\
\
	/* Data arrays */\
...
#define MOLDYN_SIMPLE_COMMON_ALLOC /* Allocate data/index arrays */\
...
#define MOLDYN_SIMPLE_COMMON_INIT /* Init data/index arrays */\
...
#define MOLDYN_SIMPLE_COMMON_ORIG /* Print data/index arrays before original computation */\
...
#define MOLDYN_SIMPLE_COMMON_COMPARE /* Compare data/index arrays to ensure they are the same */\
...
#define MOLDYN_SIMPLE_COMMON_FREE /* Free space allocated for data/index arrays */\
