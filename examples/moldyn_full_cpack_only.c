void inspector_cpack_only(int n_inter,int n_moles,int n_tstep,double data[][9],int * inter1,int * inter2,ExplicitRelation **sigma)
{
...
void executor_cpack_only(int n_inter,int n_moles,int n_tstep,double data[][9],int * inter1,int * inter2,ExplicitRelation **sigma)
{
  ExplicitRelation * cpack_input_ER;
  ExplicitRelation * sigma_ER;
  ExplicitRelation * inter1_ER;
...
data[ %(a1)s ][ 7 ] = 0.0;
data[ %(a1)s ][ 8 ] = 0.0; */
  /* a1: {[tstep,i]->[sigma_out1]: sigma_out1+-1sigma(i)=0} */
  #define S0(tstep,i) data[ ER_out_given_in(sigma_ER,i) ][ 3 ] += data[ ER_out_given_in(sigma_ER,i) ][ 0 ] + data[ ER_out_given_in(sigma_ER,i) ][ 6 ];\
data[ ER_out_given_in(sigma_ER,i) ][ 4 ] += data[ ER_out_given_in(sigma_ER,i) ][ 1 ] + data[ ER_out_given_in(sigma_ER,i) ][ 7 ];\
data[ ER_out_given_in(sigma_ER,i) ][ 5 ] += data[ ER_out_given_in(sigma_ER,i) ][ 2 ] + data[ ER_out_given_in(sigma_ER,i) ][ 8 ];\
if (data[ ER_out_given_in(sigma_ER,i) ][ 3 ] < 0.0) data[ ER_out_given_in(sigma_ER,i) ][ 3 ] += side;\
if (data[ ER_out_given_in(sigma_ER,i) ][ 3 ] > side) data[ ER_out_given_in(sigma_ER,i) ][ 3 ] -= side;\
if (data[ ER_out_given_in(sigma_ER,i) ][ 4 ] < 0.0) data[ ER_out_given_in(sigma_ER,i) ][ 4 ] += side;\
if (data[ ER_out_given_in(sigma_ER,i) ][ 4 ] > side) data[ ER_out_given_in(sigma_ER,i) ][ 4 ] -= side;\
if (data[ ER_out_given_in(sigma_ER,i) ][ 5 ] < 0.0) data[ ER_out_given_in(sigma_ER,i) ][ 5 ] += side;\
if (data[ ER_out_given_in(sigma_ER,i) ][ 5 ] > side) data[ ER_out_given_in(sigma_ER,i) ][ 5 ] -= side;\
data[ ER_out_given_in(sigma_ER,i) ][ 0 ] += data[ ER_out_given_in(sigma_ER,i) ][ 6 ];\
data[ ER_out_given_in(sigma_ER,i) ][ 1 ] += data[ ER_out_given_in(sigma_ER,i) ][ 7 ];\
data[ ER_out_given_in(sigma_ER,i) ][ 2 ] += data[ ER_out_given_in(sigma_ER,i) ][ 8 ];\
data[ ER_out_given_in(sigma_ER,i) ][ 6 ] = 0.0;\
data[ ER_out_given_in(sigma_ER,i) ][ 7 ] = 0.0;\
data[ ER_out_given_in(sigma_ER,i) ][ 8 ] = 0.0;
...
data[ %(a43)s ][ 2 ] += data[ %(a43)s ][ 8 ]; */
  /* a43: {[tstep,i]->[sigma_out1]: sigma_out1+-1sigma(i)=0} */
  #define S3(tstep,i) data[ ER_out_given_in(sigma_ER,i) ][ 6 ] *= timeStepSqHalf;\
data[ ER_out_given_in(sigma_ER,i) ][ 7 ] *= timeStepSqHalf;\
data[ ER_out_given_in(sigma_ER,i) ][ 8 ] *= timeStepSqHalf;\
data[ ER_out_given_in(sigma_ER,i) ][ 0 ] += data[ ER_out_given_in(sigma_ER,i) ][ 6 ];\
data[ ER_out_given_in(sigma_ER,i) ][ 1 ] += data[ ER_out_given_in(sigma_ER,i) ][ 7 ];\
data[ ER_out_given_in(sigma_ER,i) ][ 2 ] += data[ ER_out_given_in(sigma_ER,i) ][ 8 ];
