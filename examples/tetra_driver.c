...
/* For no transformations: iegen/bin/iegen examples/tetra.spec -o examples/tetra_notrans.c --inspector-name=inspector_notrans --executor-name=executor_notrans*/
...
/* g++ ./examples/tetra_driver.c -g -I./src/dev src/dev/ExplicitRelation.c src/dev/RectDomain.c src/dev/util.c src/dev/ERG_cpack.c -o ./examples/tetra
_driver && ./examples/tetra_driver */
...
int main()
{
	...
	executor_notrans(N,res_notrans,data_notrans,n4_notrans,n1_notrans,n2_notrans,n3_notrans);
	printf("done\n");
	...
	inspector_trans(N,res_notrans,data_notrans,n4_notrans,n1_notrans,n2_notrans,n3_notrans,sigma);
	printf("done\n");
	printf("Performing transformed computation... ");
	executor_trans(N,res_notrans,data_notrans,n4_notrans,n1_notrans,n2_notrans,n3_notrans,sigma);
	printf("done\n");
